...
- Input files
  ...
  │   ├── example1.png                     # README poster example
  │   ├── example2.png
  │   ├── example3.png
  │   └── example4.png
  │
...
- Output files
  ...
  ```python
  output/
  ├── run.log                              # Log from the current program run
  │
  ...
  │       ├── main_section.json             # Main sections used for paper-type classification
  ...
  │       └── poster/
  │           ├── poster_layout.json        # Current layout parameters
  │           ├── layout_reviews.json       # VLM review history for both columns
  │           ├── iterations/               # Column-layout iteration history
  │           │   └── iteration_<n>/
  │           │       ├── left.png
  │           │       ├── right.png
  │           │       ├── layout.json

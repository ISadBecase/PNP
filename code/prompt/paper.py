EXTRACT_PROMPTS = {
    "motivation": """Organize the following research motivation text into a structured format. IMPORTANT: Keep ALL information, do NOT summarize or omit any details.
...
[Any relevant background information mentioned]""",
    "solution": """Organize the following methodology text into a structured format. CRITICAL: Keep ALL technical details, ALL formulas/equations, and ALL component descriptions. Do NOT summarize.
...
[What makes this approach novel or different from prior work]""",
    "results": """Organize the following experimental results into a structured format. CRITICAL: Keep ALL numbers, ALL percentages, ALL table data EXACTLY as they appear. Do NOT round or omit any values. IMPORTANT: Use HTML table format (<table>...</table>) for ALL tables, NOT markdown format (| xxx |).
...
<table><tr><th>Method</th><th>Metric1</th><th>Metric2</th></tr><tr><td>Method1</td><td>value</td><td>value</td></tr></table>

## PERFORMANCE BY CATEGORY/SPLIT
[If available, show detailed breakdown by category/task/dataset using HTML table]
<table><tr><th>Category</th><th>Metric1</th><th>Metric2</th></tr><tr><td>Category1</td><td>value</td><td>value</td></tr></table>

## ABLATION STUDY
[If available, complete ablation results with ALL numbers using HTML table]
<table><tr><th>Variant</th><th>Metric1</th><th>Metric2</th></tr><tr><td>-Component</td><td>value</td><td>value</td></tr></table>
...
[If available, detailed comparison with baseline methods, explaining performance differences]""",
    "contributions": """Extract all contributions, novelty claims, limitations, and future directions from the text. Keep ALL details, do NOT summarize.
